...
//    private UpdateDrawer mUpdateDrawer;
...
//        selectItem(mCurrentSelectedPosition);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mDrawerListView = (ListView) view.findViewById(R.id.drawer_menu_list);
        ...
        String[] menuArray = getResources().getStringArray(R.array.drawer_titles);
        mDrawerAdapter = new DrawerAdapter(getActivity(), Arrays.asList(menuArray));
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout) {
        setUp(getActivity().findViewById(fragmentId), drawerLayout);
...
//        mDrawerLayout.setDrawerShadow(R.drawable.drawer_shadow, GravityCompat.START);
        // set up the drawer's list tac.com.m2m.view with items and click listener
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                mCallbacks.onScroll(slideOffset);
            }
    ...
    protected void justSelectItem(int position) {
        if (mDrawerAdapter != null && mCurrentSelectedPosition != position) {
